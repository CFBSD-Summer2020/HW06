...
```
    ...
    ## * Name -> Name...1
    ## * Length -> Length...2
    ## * EffectiveLength -> EffectiveLength...3
    ## * TPM -> TPM...4
    ## * NumReads -> NumReads...5
    ## * ...
...
```
    ...
    ## [13] tidyr_1.1.1             tibble_3.0.1            ggplot2_3.3.2          
    ## [16] tidyverse_1.3.0         dplyr_1.0.0             readr_1.3.1            
    ## 
    ...
    ## [73] vctrs_0.3.1                 cellranger_1.1.0           
