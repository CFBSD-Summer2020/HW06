...
#Dan: Since I prepared my data frame long-wise and I intended to have duplicated gene symbols (each duplicate has their own TPM values assigned), I'm commenting out the line below
...
for (gene in genes_of_interest) {
  ...
  mut_gene <- GBM.genes.of.interest %>%
    filter(gene_symbol == gene, type == "H3K27M")
